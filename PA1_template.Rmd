...
```{r makehist1,echo=TRUE, fig.width=8}
...
```{r maketsplot,echo=TRUE, fig.width=8}
...
Here's the answer: The 5-minute interval containing the maximum number of steps is `r MaxPt$interval` and the maximum # of steps is `r MaxPt$steps`, as seen below
...
```{r tsplot2,echo=TRUE, fig.width=8}
